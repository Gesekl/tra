...
var cfMongoUrl = (function() {
  if (appEnv.getService('track-mongo')) {
    var mongoCreds = appEnv.getService('track-mongo').credentials;
    return mongoCreds.uri || mongoCreds.url;
  } else {
    throw new Error('No service names "track-mongo" bound to the application.');
  }
}());
