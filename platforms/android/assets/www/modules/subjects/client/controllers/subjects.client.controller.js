(function () {
  ...
  SubjectsController.$inject = ['$scope', '$state', '$window', 'Authentication', 'subjectResolve','BatchesService','LecturesService', 'PosService', 'PsosService'];

  function SubjectsController ($scope, $state, $window, Authentication, subject, BatchesService, LecturesService, PosService, PsosService ) {
    var vm = this;
